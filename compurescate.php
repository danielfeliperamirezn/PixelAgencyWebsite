...
?>
    ...
    <section class="containerProductDetails">
        <div class="containerHeaderProduct">
            <figure>
                <img src="img/Portafolio/compurescate/1.jpg" alt="compurescate">
            </figure>
        ...
        <div class="resumenWebsite">
            ...
            <div class="contentImageClient">
                <figure>
                    <img src="img/Portafolio/compurescate/2.jpg" alt="Compurescate">
                </figure>
                <figure>
                    <img src="img/Portafolio/compurescate/3.jpg" alt="Compurescate">
                </figure>
            </div>
        </div>
    </section>
    <div class="container_next_product">
        <a href="3wishes.php">Próximo Cliente - <span>3 Wishes Event Designers...</span> <span class="espacio"> &#160; </span></a>
    </div>
