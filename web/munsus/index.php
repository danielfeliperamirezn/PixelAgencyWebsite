...
?>
    ...
    <section class="containerProductDetails">
        <div class="containerHeaderProduct">
            <figure>
                <img src="../assets/img/Portafolio/munsus/principal.jpg" alt="munsus">
            </figure>
        ...
        <div class="resumenWebsite">
            ...
            <div class="contentImageClient">
                <figure>
                    <img src="../assets/img/Portafolio/munsus/1.jpg" alt="Munss">
                </figure>
                <figure>
                    <img src="../assets/img/Portafolio/munsus/2.jpg" alt="Mundial de Suspensones">
                </figure>
            </div>
        </div>
    </section>
    <div class="container_next_product">
        <a href="../seiki">Próximo Cliente - <span>Sei-ki...</span> <span class="espacio"> &#160; </span></a>
    </div>
